...
const mockLeaderboard = [{ address: 'GCCCC...CCC', totalXlm: 150.5, bountiesCompleted: 3 }];
...
describe('ContributorProfilePage', () => {
  it('renders stats and completed bounties from API', async () => {
    render(
      <ContributorProfilePage address={'GCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'} />
    );
